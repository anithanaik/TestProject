...
namespace ClassLibrary1
{
    public class UserGroupContent
    {
        ...
        UserInfo userInfo;
        public UserGroupContent(IWebDriver driver)
        {
            WebDriver = driver;
            userInfo = new UserInfo(WebDriver);
        ...
        public void MyContent()
        {
           ...
           // PageServices.WaitForPageToCompletelyLoaded(WebDriver, 200);
            WebDriverExtensions.WaitUntilElementVisible(WebDriver, myContentHeadCSS,120);
            Console.WriteLine(MyContentHeader.Text);
           // WebDriverExtensions.WaitForReady(WebDriver, 180);            
            Thread.Sleep(5000);
            WebDriverExtensions.WaitUntilElementVisible(WebDriver, filterContentCSS, 120);          
            WebDriverExtensions.WaitUntilElementClickable(WebDriver, filterMyContent, 120);
            filterMyContent.Click();
            PageServices.WaitForPageToCompletelyLoaded(WebDriver, 120);
            Thread.Sleep(3000);
            WebDriverExtensions.WaitUntilElementClickable(WebDriver, publishedStatus, 120);
            publishedStatus.Click();
            Thread.Sleep(2000);
            publishedStatusOption.Click();
            Thread.Sleep(2000);
            ...
            filterMyContent.Click();
            PageServices.WaitForPageToCompletelyLoaded(WebDriver, 300);
            Thread.Sleep(2000);
            groupFilter.Click();
            Thread.Sleep(2000);
            groupSelect.Click();
            ...
            Console.WriteLine(MyContentHeader.Text);
            WebDriverExtensions.WaitForReady(WebDriver, 180);
            //WebDriverExtensions.WaitForReady(WebDriver, 120);
            //Thread.Sleep(5000);
            //PageServices.WaitForPageToCompletelyLoaded(WebDriver, 300);
            Assert.AreEqual(MyContentHeader.Text, myContentHeader);

            WebDriverExtensions.WaitUntilElementClickable(WebDriver, editContent, 120);
            editContent.Click();
            Thread.Sleep(5000);
           // WebDriverExtensions.WaitForReady(WebDriver, 120);
            PageServices.WaitForPageToCompletelyLoaded(WebDriver, 120);
            ...
            //Thread.Sleep(1000);
           // PageServices.WaitForPageToCompletelyLoaded(WebDriver, 120);
            WebDriverExtensions.WaitUntilElementClickable(WebDriver, save, 120);
            PageServices.ScrollPageUptoBottom(WebDriver);
            save.Submit();
            // save.Click();
            //WebDriverExtensions.WaitForReady(WebDriver, 120);

            //PageServices.WaitForPageToCompletelyLoaded(WebDriver, 600);
            // Thread.Sleep(6000);
            PageServices.ScrollPageUptoBottom(WebDriver);
           Thread.Sleep(6000);
            WebDriverExtensions.WaitUntilElementVisible(WebDriver, verificationMsgCSS, 120);
            Assert.That(verificationMsg.GetAttribute("textContent"), Does.Contain(updateText).IgnoreCase);
            Console.WriteLine("Content Saved");
          
            PageServices.WaitForPageToCompletelyLoaded(WebDriver, 500);
            userInfo.MyContentMenu();
            PageServices.WaitForPageToCompletelyLoaded(WebDriver, 200);
            WebDriverExtensions.WaitUntilElementVisible(WebDriver, myContentHeadCSS, 120);
            Console.WriteLine(MyContentHeader.Text);
