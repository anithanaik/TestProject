...
namespace ClassLibrary1
{
    ...
    {
        IWebDriver conversationGroupDriver;
        public ConversationGroup(IWebDriver driver)
        {
            conversationGroupDriver = driver;
            PageFactory.InitElements(this, new RetryingElementLocator(conversationGroupDriver, TimeSpan.FromSeconds(90)));
            grpActivity = new GroupsActivity(conversationGroupDriver);
            cmGrps = new CommonsGroups(conversationGroupDriver);
        }
        ...
        public void verifyConversationGrpItems()
        {
           ...
           //cmGrps.OpenJoinedGroup();
            Console.WriteLine("*********** Group Conversation**********");
            conversationSection.Click();
            Thread.Sleep(2000);
            Assert.That(conversationGroupDriver.Url, Does.Contain(convUrl).IgnoreCase);
            Assert.AreEqual(filterAllText, filterAll.Text);
            Assert.AreEqual(filterByMonthText, filterByMonth.Text);
            IJavaScriptExecutor js = (IJavaScriptExecutor)conversationGroupDriver;
            js.ExecuteScript("window.scrollBy(0,-250)", "");
            addNewItem.Click();
            Thread.Sleep(2000);
            conversationGroupDriver.SwitchTo().Frame(conversationFrame);
            conversationGroupDriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            ...
            //PageServices.WaitForPageToCompletelyLoaded(conversationGroupDriver, 120);
            //Thread.Sleep(5000);
            //IList<IWebElement> userLis = WebDriverExtensions.FindElements(conversationGroupDriver, By.CssSelector("#content > div > div > div > div > div > article > div > header > div.post__meta > a"), 120);
            //userLis[0].Click();
            //PageServices.WaitForPageToCompletelyLoaded(conversationGroupDriver, 120);
            //Thread.Sleep(5000);
            ////userDetails.Click();
            //conversationGroupDriver.Navigate().Back();
            //userPic.Click();
            //PageServices.WaitForPageToCompletelyLoaded(conversationGroupDriver, 120);
            //Thread.Sleep(5000);
            //conversationGroupDriver.Navigate().Back();
            ...
            Console.WriteLine("*********** Group Video**********");
            videosSection.Click();
            PageServices.WaitForPageToCompletelyLoaded(conversationGroupDriver, 120);
            Thread.Sleep(2000);
            Assert.That(conversationGroupDriver.Url, Does.Contain(videosUrl).IgnoreCase);
            Thread.Sleep(2000);
            ...
            Console.WriteLine("Filter by Month and Month format: " + monthText.Trim());
            Thread.Sleep(2000);
            FilterByAll.Click();
            ...
            videoFilter.Click();
            Thread.Sleep(2000);
            Actions action = new Actions(conversationGroupDriver);
            ...
            //Thread.Sleep(5000);
            //PageServices.WaitForPageToCompletelyLoaded(conversationGroupDriver, 200);
